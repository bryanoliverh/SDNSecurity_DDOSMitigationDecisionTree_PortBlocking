...
class datacentertopo(Topo):
    ...
    def build(self):
        ...
        self.addLink(s6, s3 ,cls = TCLink,bw=80)
        self.addLink(s6, s4 ,cls = TCLink,bw=80)

        #addlinks s2--All Switches
        self.addLink(s5, s1 ,cls = TCLink,bw=80)
        self.addLink(s5, s2 ,cls = TCLink,bw=80)

        #addlinks s7--All Switches
        self.addLink(s7, s5 ,cls = TCLink,bw=120)
        self.addLink(s7, s6, cls = TCLink,bw=120)
